...
namespace API.Controller
{
    ...
    [ApiController]
    public class MonitorOrderDetailController : ControllerBase
    {
        IOrderMonitorDetail _Service;
        public MonitorOrderDetailController(IOrderMonitorDetail service)
        {
            _Service = service;
        }
        [HttpGet]
        [Route("get-all-order-detail-monitor-detail")]
        ...
        [HttpPost]
        [Route("create-Order-detail-monitor-detail")]
        public async Task<IActionResult> Create(CreateOrderMonitorDetail create)
        {
